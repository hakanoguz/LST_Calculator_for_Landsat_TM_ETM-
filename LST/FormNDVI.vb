...
Public Class FormNDVI
    ...
    Private Sub btnOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnOK.Click
        If TextBox1.Text.Length = 0 Or TextBox2.Text.Length = 0 Or TextBox3.Text.Length = 0 Then
            MessageBox.Show("Oops, you must be forgetting something here :)  Before pressing OK button, you MUST input Band 3 and Band 4. Then SELECT a directory where the output file will be saved to!!!", "Warning!")
            Me.btnBrowse1.Focus()
        Else
            ...
            Else
                ...
                MessageBox.Show("NDVI file has been created succesfully!", "Done")
                Me.Close()
            End If
