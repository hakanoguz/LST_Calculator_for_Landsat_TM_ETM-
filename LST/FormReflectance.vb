...
Public Class FormReflectance
    ...
    Private Sub btnOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnOK.Click
        If TextBox1.Text.Length = 0 Or TextBox2.Text.Length = 0 Or TextBox3.Text.Length = 0 Or TextBox4.Text.Length = 0 Or TextBox5.Text.Length = 0 Then
            MessageBox.Show("Oops, you must be forgetting something here :)  Before pressing OK button, you MUST enter TOA Radiance file and other parameters. Then SELECT a directory where the output file will be saved to!!!", "Warning!")
            Me.btnBrowse.Focus()
        Else
            ...
            s1.Close()
            s3.Close()
            MessageBox.Show("Reflectance file has been created succesfully!", "Done")
            Me.Close()
        End If
    End Sub
