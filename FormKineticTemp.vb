    ...
    Private Sub btnOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnOK.Click
        ...
        Else
            ...
            Else
                ...
                Dim upwelling As Single
                Dim downwelling As Single
                Dim atmospheric As Single

                upwelling = CSng(TextBox4.Text)
                downwelling = CSng(TextBox5.Text)
                atmospheric = CSng(TextBox6.Text)

                'Read binary files and do math calc... 
                For i = 0 To fLen1 - 1
                    snglRead1 = br1.ReadSingle()
                    snglRead2 = br2.ReadSingle()
                    snglOutput = ((snglRead1 - upwelling - atmospheric * (1 - snglRead2) * downwelling) / (atmospheric * snglRead2))
                    bw.Write(snglOutput)
                Next
