...
Partial Class FormReflectance
    ...
    Private Sub InitializeComponent()
        ...
        Me.Label4.Text = "Path to the TOA Radiance file (data type float)"
        '
        'Label5
        '
        ...
        Me.Label6.Size = New System.Drawing.Size(443, 40)
        Me.Label6.TabIndex = 14
        Me.Label6.Text = "NOTE: Please use a decimal point (not a decimal comma) when you ınput a decimal n" & _
            "umber above..."
        '
        'Label7
        '
